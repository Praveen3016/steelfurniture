      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Kheteshwar Steel Factory.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Kheteshwar Steel Factory,
            accessible from{" "}
            <a
              href="https://steelfactory.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://steelfactory.com
            </a>
          </p>
        </li>
        <li>
